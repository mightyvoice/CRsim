...
#include "Globecom15.h"

Globecom15::Globecom15(): CRNetwork()
{
    initAllSU();
}

void Globecom15:: initAllSU()
{
    for(int i = 0; i < 2; i++){
        MySU tmp;
...
void Globecom15:: initSuNeighborSector(MySU &su)
{
    su.initSectorSplit();
    memset(su.sectorNeighborPU, 0, sizeof(su.sectorNeighborPU));
    for(int i = 0; i < su.transSectorNum; i++){
        for(int j = 0; j < global::PU_NUM; j++){
            if(CRmath::twoPointsDistanceSquare(su.location.first, su.location.second, allPU[j].location.first, allPU[j].location.second) <= global::SENSE_RANGE_SU * global::SENSE_RANGE_SU &&
...
void Globecom15:: getRendPair(const MySU &su0, const MySU &su1)
{
...
void Globecom15:: getAvaiChanEachSector(MySU &su, int t, int _sector)
{
    su.avaiChan.clear();
...
void Globecom15:: sectorRendOnly()
{
    SectorHop s0(global::SEND_SECTOR_NUM, global::SEND);
    SectorHop s1(global::REV_SECTOR_NUM, global::RECEIVE);
    rendPair = make_pair(CRmath::randInt(0, global::SEND_SECTOR_NUM-1), CRmath::randInt(0, global::REV_SECTOR_NUM-1));
...
void Globecom15:: initChannelAndSectorRend()
{
    MySU &su0 = allSU[0];
    MySU &su1 = allSU[1];
...
void Globecom15:: channelAndSectorRend(int t)
{
    MySU &su0 = allSU[0];
    MySU &su1 = allSU[1];
    su0.channelHopCount++;
...
void Globecom15:: initChannelAndSectorRendRandom()
{
    MySU &su0 = allSU[2];
    MySU &su1 = allSU[3];
    su0.channelHopCount = 0;
...
void Globecom15:: channelAndSectorRendRandom(int t)
{
    MySU &su0 = allSU[2];
    MySU &su1 = allSU[3];
    int  c0, c1;
...
void Globecom15:: initSimulation()
{
...
void Globecom15::startSimulation()
{
